...
public class GUI extends javax.swing.JFrame {
    ...
    private final DefaultListModel portsModel;
    ...
    public GUI() {
        ...
        lstAddresses.setModel(portsModel);
    ...
    public void addPort(int port) {
        SwingUtilities.invokeLater(() -> {
            portsModel.addElement(port);
            lstAddresses.setModel(portsModel);
            lblFound.setText("Servers Found: " + portsModel.size());
        });
    }

    public void addPossiblePort(int ip) {
        SwingUtilities.invokeLater(() -> {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelScan, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnScanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScanActionPerformed
        if (txtAddress.getText().equals("")
            ...
            Matcher m1 = pattern.matcher(txtTimeout.getText());
            ...
            if (m1.find()) {
                ...
                PortScanner ps = new PortScanner(address, timeout);
                new Thread() {
                    @Override
                    public void run() {
                        ps.start();
                ...
                lblMessage.setText("Please only enter a numerical value for timeout value");
            }
        }
    ...
    private void chkResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkResultsActionPerformed
        PortScanner.save = chkResults.isSelected();
    ...
    private void lstAddressesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstAddressesMouseClicked
        if (evt.getClickCount() == 2 && !portsModel.isEmpty()) {
